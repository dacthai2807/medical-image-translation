...
from datasets import get_dataset, get_PETnCT_dataset
...
def main(args):
    ...
    dataset = get_PETnCT_dataset(pet_dir, ct_dir, train_flist, train_flist)
...
if __name__ == "__main__":
    dataset = 'pet2ct' #cat2dog/wild2dog/male2female/multi_afhq(mutli-domain)
    #defalut args
    ...
    if dataset == 'multi_afhq':
        ...
        args.num_class = 2
        args.iterations = 5000
        args.pretrained_model = 'pretrained_model/petnct_classifier.pt'
        args.image_size = 128
    main(args)
